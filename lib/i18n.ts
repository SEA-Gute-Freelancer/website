...
const about = {
  de: {
    hero: {
      ...
      p: "SEA Gute Freelancer ist ein Kollektiv von Spezialisten, Experten, Profis – aber in erster Linie von Freunden. Wir haben uns bei Google oder bei Google Vendors kennengelernt, waren gemeinsam reisen, haben zusammengewohnt und helfen uns gegenseitig. Wir leben alle nicht mehr am gleichen Ort – aber wir brennen für die gleichen Leidenschaften.",
    },
    story: {
      h2: "Wie alles begann.",
      p1: "2025 in Portugal. Ein Großraumbüro.",
      p2: "Als Googler haben wir mit Agenturen, Gründern und Freelancern zusammengearbeitet und sie beraten. Immer up-to-date, immer top-notch. Irgendwann die Erkenntnis: Das können wir besser als die meisten.",
      p3: "Nach einigen Privatkunden, bei denen wir uns immer gegenseitig ausgeholfen haben, dann die Überlegung: Warum kein Kollektiv gründen?",
  ...
  en: {
    hero: {
      ...
      p: "SEA Gute Freelancer is a collective of specialists, experts, and pros – but above all, friends. We met at Google or through Google vendors, travelled together, lived together, and still have each other's backs. We don't all live in the same city anymore – but we burn for the same things.",
    },
    story: {
      h2: "How it all began.",
      p1: "2025. Portugal. An open-plan office.",
      p2: "As Googlers, we worked with agencies, founders and freelancers – always advising, always up-to-date, always top-notch. Then the realisation hit: we could do this better than most.",
      p3: "After a few private clients where we'd always backed each other up, the obvious question came: why not make this a collective?",
      cta: "Meet the crew",
    },
    values: {
      label: "Our values",
...
const leistungen = {
    ...
    services: [
      {
        ...
        subtitle: "Sichtbarkeit, wenn es zählt",
        desc: "Deine Anzeigen erscheinen genau dann, wenn potenzielle Kunden nach deinen Produkten oder Dienstleistungen suchen. Wir entwickeln präzise Keyword-Strategien, schreiben überzeugende Anzeigentexte und optimieren kontinuierlich für maximalen ROI.",
        features: [
          "Tiefgehende Keyword-Recherche & Wettbewerbsanalyse",
          "Professionelles Anzeigentexting mit A/B-Testing",
          "Granulare Kampagnenstruktur für optimale Kontrolle",
          "Laufende Gebotsoptimierung und Qualitätsscore-Management",
      ...
      },
      {
        ...
        subtitle: "KI-gestützte Reichweite",
        desc: "Performance Max Kampagnen nutzen Googles maschinelles Lernen, um deine Anzeigen über alle Kanäle hinweg zu optimieren: Search, Display, YouTube, Gmail und Maps. Wir konfigurieren und überwachen diese Kampagnen für optimale Ergebnisse.",
        features: [
          "Strategische Asset-Group-Struktur für maximale Relevanz",
          "Professionelle Asset-Erstellung und -Optimierung",
          "Audience Signals für präziseres Targeting",
          "Conversion-Tracking und Attribution Setup",
          "Regelmäßige Insights-Analyse und Anpassung",
        ],
        tag: "KI-gestützt",
      },
      {
        title: "Shopping Ads",
        subtitle: "Mehr Umsatz im E-Commerce",
        desc: "Google Shopping Anzeigen bringen deine Produkte direkt ins Suchfeld. Wir optimieren deinen Produkt-Feed, strukturieren deine Shopping-Kampagnen professionell und sorgen dafür, dass die richtigen Produkte den richtigen Kunden gezeigt werden.",
        features: [
          "Google Merchant Center Setup und Feed-Optimierung",
          "Standard Shopping & Performance Max Integration",
          "Produktbewertungen und Rich Snippets",
          "Saisonale Kampagnen und Aktionszeiträume",
          "ROAS-Optimierung nach Produktkategorien",
        ],
        tag: "E-Commerce",
      },
      {
        title: "Remarketing",
        subtitle: "Interessenten zurückgewinnen",
        desc: "Nicht jeder Besucher kauft beim ersten Kontakt. Remarketing-Kampagnen erinnern Interessenten mit passgenauen Botschaften an dein Angebot und holen sie zurück – kosteneffizient und zielgenau.",
        features: [
          "Zielgruppensegmentierung nach Verhalten und Interaktion",
          "Dynamic Remarketing für personalisierte Produktanzeigen",
          "Customer Match und ähnliche Zielgruppen",
          "Cross-Device-Tracking für nahtlose User Journey",
          "Frequency Capping gegen Werbeermüdung",
        ],
        tag: "Conversion",
      },
    ],
  ...
  en: {
    ...
    services: [
      {
        title: "Google Search Ads",
        subtitle: "Visibility when it counts",
        desc: "Your ads show up at the exact moment people search for what you offer. We build precise keyword strategies, write copy that converts, and keep optimising until the numbers move.",
        features: [
          "In-depth keyword research & competitor analysis",
          "Ad copywriting with A/B testing built in",
          "Granular campaign structure for full control",
          "Ongoing bid optimisation and Quality Score management",
      ...
      {
        title: "Performance Max",
        subtitle: "AI-powered reach",
        desc: "Performance Max uses Google's machine learning to push your ads across every channel – Search, Display, YouTube, Gmail and Maps. We configure and watch over these campaigns so the machine works in your favour.",
        features: [
          "Strategic asset group structure for maximum relevance",
          "Professional asset creation and optimisation",
          "Audience signals for sharper targeting",
          "Conversion tracking and attribution setup",
          "Regular insights analysis and adjustment",
        ],
        tag: "AI-powered",
      },
      {
        title: "Shopping Ads",
        subtitle: "More e-commerce revenue",
        desc: "Google Shopping puts your products right in the search results. We optimise your feed, structure your campaigns properly, and make sure the right products reach the right customers.",
        features: [
          "Google Merchant Center setup and feed optimisation",
          "Standard Shopping & Performance Max integration",
          "Product ratings and rich snippets",
          "Seasonal campaigns and promotional bursts",
          "ROAS optimisation by product category",
        ],
        tag: "E-Commerce",
      },
      {
        title: "Remarketing",
        subtitle: "Win back warm leads",
        desc: "Not every visitor buys on the first visit. Remarketing campaigns bring them back with the right message at the right moment – cost-efficiently and without being annoying.",
        features: [
          "Audience segmentation by behaviour and interaction",
          "Dynamic remarketing for personalised product ads",
          "Customer Match and similar audiences",
          "Cross-device tracking for a seamless user journey",
